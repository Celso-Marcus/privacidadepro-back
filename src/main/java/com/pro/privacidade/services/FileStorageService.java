...
import com.pro.privacidade.config.FileStorageConfig;
...
public class FileStorageService {
    ...
    public String storeFile(MultipartFile file, String category) {
        ...
        try {
            ...
            String dateNow = LocalDateTime.now().atZone(ZoneId.of("America/Sao_Paulo")).format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss"))
